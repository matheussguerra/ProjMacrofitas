...
def sinonimos():
	...
	for plant in plants:
		try:
			...
			formaVida_arr.append(['Não Encontrado'.decode('utf-8')])
			substrato_arr.append(['Não Informado'.decode('utf-8')])
			origem_arr.append('Não Informado'.decode('utf-8'))
			endemismo_arr.append('Não Informado'.decode('utf-8'))
			distribuicao_arr.append(['Não Informado'.decode('utf-8')])
